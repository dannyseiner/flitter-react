        ...
        <div className="profile-container box-shadow">
            ...
            <div className="row">
                ...
                <div className="rightcolumn">
                    ...
                    <div className="card">
                        <h3>Popular Post</h3>
                        <div className="fakeimg"><i class="fas fa-birthday-cake"></i>10.10.2020</div>
                        <div className="fakeimg"><i class="fas fa-mail-bulk"></i>Image</div>
                        <div className="fakeimg"><i class="fas fa-genderless"></i>Image</div>
                    </div>
                    <div className="card">
                        <h3>Follow Me</h3>
                        <p>Some text..</p>
